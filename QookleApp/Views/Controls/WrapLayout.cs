namespace QookleApp.Views.Controls
{
    ...
    public class WrapLayout : Layout<View>
    {
        ...
        public static BindableProperty SpacingProperty
        {
            get
            {
                return _spacingProperty
                       ?? (_spacingProperty = BindableProperty.Create<WrapLayout, double>(w => w.Spacing, 6.0));
            }
        }
        ...
        private SizeRequest DoHorizontalMeasure(double widthConstraint, double heightConstraint)
        {
            ...
            if (rowCount > 1)
            {
                ...
                height = height * rowCount + rowCount * Spacing; // take max height
            }
